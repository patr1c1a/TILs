...
The usual method of software versioning is `major.minor.patch` (although there are others) and this is called "semantic versioning". [There is also a specification for it](https://semver.org).
